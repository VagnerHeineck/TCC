...
class PubMed(object):
    ...
    def query(self: object, query: str, max_results: int = 100):
        ...
        article_ids = self.getArticleIds(query=query, max_results=max_results)

        # Get the articles themselves
        articles = list(
            [
                self.getArticles(article_ids=batch)
    ...
    def getArticles(self: object, article_ids: list) -> list:
    ...
    def getArticleIds(self: object, query: str, max_results: int) -> list:
